...
//    vido_cursor.style.left = elem.x + "px";
//    vido_cursor.style.top = elem.y + "px";
// }) // it is help for center the cirlce play button of the video. but it is'nt worked.

function video_btn_animation()
{
  var flag = 0
